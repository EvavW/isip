...
plot [-4.75343910607888:-0.253347103317183] [-1.64485362793551:2.05374890849825] \
  ...
  'overall_EMORY/nist/nist.dets/sum.isometriclines' title 'Iso-TWV lines' with lines lt rgb "#b0b0b0b" lw 1,\
  'overall_EMORY/nist/nist.dets/sum.Occurrence.dat.1' using 3:2 notitle with  lines  lc 2 lw 1,\
    'overall_EMORY/nist/nist.dets/sum.Occurrence.dat.2' using 11:10 title 'Occurrence: Act  TWV=0.6012  PMiss= 0.233  PFA=0.00017  Thr=1.0000' with linespoints pt 7 ps 2 lc 2,\
  'overall_EMORY/nist/nist.dets/sum.Occurrence.dat.2' using 6:5 title 'Max  TWV=0.6012  PMiss= 0.233  PFA=0.00017  Thr=1.0000' with points lc 2 pt 6 lw 1 ps 2