...
class compare_annotation_files(object):
    ...
    def __init__(self,verbose_flag, tolerance, delta, output_file):
        ...
        self.fo = open(self.output_file,'a')
        self.fo.write("The results of interrater agreement are as follows:\n\n")
        ...
        ##        <-------> <----------->........................................................ confirm this
            ...
            if self.hyp_seiz_start_time_array[self.hyp_index] <= self.ref_seiz_start_time_array[self.ref_index]:
                ...
                if self.hyp_seiz_stop_time_array[self.hyp_index] <= self.ref_seiz_stop_time_array[self.ref_index] and self.hyp_seiz_stop_time_array[self.hyp_index] > self.ref_seiz_start_time_array[self.ref_index]:
                    ...
                    ## Loop condition --> 1
                    while  self.hyp_seiz_stop_time_array[self.hyp_index] <= self.ref_seiz_stop_time_array[self.ref_index] and self.hyp_seiz_start_time_array[self.hyp_index] <= self.ref_seiz_stop_time_array[self.ref_index]:
                ...
                ## condition --> 5
                try:
                    if self.hyp_seiz_start_time_array[self.hyp_index] < self.ref_seiz_start_time_array[self.ref_index] and self.hyp_seiz_stop_time_array[self.hyp_index] > self.ref_seiz_stop_time_array[self.ref_index] and self.hyp_seiz_stop_time_array[self.hyp_index] >= self.ref_seiz_stop_time_array[self.ref_index + 1] and self.hyp_seiz_start_time_array[self.hyp_index] < self.ref_seiz_start_time_array[self.ref_index]:
...
#                    import pdb;pdb.set_trace()
                ...
                try:
                    ...
                    ########################################
                    ######################################################################################################################################################################################################################################################
                    # if self.hyp_seiz_start_time_array[self.hyp_index] < self.ref_seiz_stop_time_array[self.ref_index] and self.hyp_seiz_start_time_array[self.hyp_index] < self.ref_stop_time and self.hyp_seiz_stop_time_array[self.hyp_index] <= self.ref_stop_time: #
                    #     hit += 1                                                                                                                                                                                                                                       #
                    #                                                                                                                                                                                                                                                    #
                    #     del self.hyp_seiz_start_time_array[self.hyp_index]                                                                                                                                                                                             #
                    #     del self.hyp_seiz_stop_time_array[self.hyp_index]                                                                                                                                                                                              #
                    #                                                                                                                                                                                                                                                    #
                    #     print '## condition --> 4 except'                                                                                                                                                                                                              #
                    #     print self.ref_seiz_start_time_array                                                                                                                                                                                                           #
                    #     print self.ref_seiz_stop_time_array                                                                                                                                                                                                            #
                    #     print self.hyp_seiz_start_time_array                                                                                                                                                                                                           #
                    #     print self.hyp_seiz_stop_time_array                                                                                                                                                                                                            #
        ...
        return hit, Miss, FA, ref_total_events, self.ref_bckg_epochs,self.hyp_bckg_epochs
    ...
    #
        ...
        for _annotator, _filelist in zip(annotator_names,annotators_filelists):
            ...
            #
            exec("result_dictionary['%s'] = '%s,%s,%s,%s,%s,%s'"%(_annotator,self.total_Hit,self.total_Miss,self.total_FA,self.total_events,self.total_ref_bckg_epochs,self.total_hyp_bckg_epochs))
...
###            print key_pathlists, "  key paths for annotator:  ", _annotator
    ...
    def calc_hits_miss_FA_from_ann_files(self,filename_to_compare, *index):
        ...
        ## called 
        Hit, Miss, FA, Total_events, ref_bckg_epochs, hyp_bckg_epochs = self.compare_annotation_for_fully_annotated_files(self.reference_filelist[ref_index],filename_to_compare)
