...
def main(filelist):
    ...
    print chew_class_count , " ---->>>>> Number of chew Epochs"

    print mcle_class_count , " ---->>>>> Number of mcle Epochs"

    print seiz_class_count + bckg_class_count + mcle_class_count, " ---->>>>> Number of Total Epochs"
